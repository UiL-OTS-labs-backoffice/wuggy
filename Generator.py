...
class Generator(sequencegenerator.generator.Generator):
    ...
    def Run(self, options, reference_sequence, match_expression, outputwindow):
        ...
        active_statistics = [stat for stat in statistics if
                             options[stat] == True]
        ...
        if options['match_segment_length'] == False and options[
        ...
        while 1:
            ...
            for sequence in self.generate(clear_cache=False):
                ...
                if (options['overlapping_segments'] == True and
                        self.statistics['overlap_ratio'] != Fraction(
                ...
                if (options['match_segment_length'] == False and
                    ...
                    match = False
                if options['output_type'] == 'Only pseudowords' and \
                        self.statistics['lexicality'] == 'W':
                    match = False
                if options['output_type'] == 'Only words' and self.statistics[
                    'lexicality'] == 'N':
                    match = False
                if match_expression != u"":
                ...
                if match:
                    ...
                    if options['maxdeviation'] == True:
                        ...
                        differences = self.difference_statistics[
                            'transition_frequencies']
                        maxindex, maxdev = max(differences.items(),
