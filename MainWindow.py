...
class MainWindow(Frame):
    def __init__(self, *args, **kwds):
        ...
        self.menu_open = wx.MenuItem(self.menu_file, wx.NewId(),
                                     "&Open Input Sequences\tCtrl+O", "",
                                     wx.ITEM_NORMAL)
        self.menu_file.Append(self.menu_open)
        self.menu_save = wx.MenuItem(self.menu_file, wx.NewId(),
                                     "&Save Input Sequences\tCtrl+S", "",
                                     wx.ITEM_NORMAL)
        self.menu_file.Append(self.menu_save)
        self.menu_save_output = wx.MenuItem(self.menu_file, wx.NewId(),
                                            "Save &Output Sequences\tCtrl+Shift+S",
                                            "", wx.ITEM_NORMAL)
        self.menu_file.Append(self.menu_save_output)
        self.menu_quit = wx.MenuItem(self.menu_file, wx.ID_EXIT, "Quit\tCtrl+Q",
                                     "", wx.ITEM_NORMAL)
        self.menu_file.Append(self.menu_quit)
        self.menubar.Append(self.menu_file, "&File")
        self.menu_edit = wx.Menu()
        self.menu_cut = wx.MenuItem(self.menu_edit, wx.ID_CUT, "&Cut\tCtrl+X",
                                    "", wx.ITEM_NORMAL)
        self.menu_edit.Append(self.menu_cut)
        self.menu_copy = wx.MenuItem(self.menu_edit, wx.ID_COPY,
                                     "Cop&y\tCtrl+C", "", wx.ITEM_NORMAL)
        self.menu_edit.Append(self.menu_copy)
        self.menu_paste = wx.MenuItem(self.menu_edit, wx.ID_PASTE,
        ...
        self.menu_run = wx.MenuItem(self.menu_generate, wx.NewId(),
                                    "&Run\tCtrl+R", "", wx.ITEM_NORMAL)
        self.menu_generate.Append(self.menu_run)
        self.menu_stop = wx.MenuItem(self.menu_generate, wx.NewId(),
                                     "&Stop\tCtrl+B", "", wx.ITEM_NORMAL)
        self.menu_generate.Append(self.menu_stop)
        self.menubar.Append(self.menu_generate, "&Generate")
        self.menu_tools = wx.Menu()
        self.menu_autosegment = wx.MenuItem(self.menu_tools, wx.NewId(),
                                            "Segmentation (Syllabify)\tCtrl+Y",
                                            "", wx.ITEM_NORMAL)
        self.menu_tools.Append(self.menu_autosegment)
        self.menu_verify = wx.MenuItem(self.menu_tools, wx.NewId(),
        ...
        self.menu_update = wx.MenuItem(self.menu_help, wx.NewId(),
                                       "&Check for Update", "", wx.ITEM_NORMAL)
        ...
        self.label_generator = wx.StaticText(self.splitterwindow_rightpanel, -1,
                                             "Language module:  ")
        self.choice_language = wx.Choice(self.splitterwindow_rightpanel, -1,
                                         choices=["Choose a language"])
        self.label_output_type = wx.StaticText(self.splitterwindow_rightpanel,
                                               -1, "Output type: ")
        self.choice_output_type = wx.Choice(self.splitterwindow_rightpanel, -1,
                                            choices=["Only pseudowords",
                                                     "Only words", "Both"])
        self.label_ncandidates = wx.StaticText(self.splitterwindow_rightpanel,
                                               -1,
                                               "Maximal number of candidates: ")
        self.choice_ncandidates = wx.SpinCtrl(self.splitterwindow_rightpanel,
                                              -1, "10", min=0, max=10000)
        self.label_per_word = wx.StaticText(self.splitterwindow_rightpanel, -1,
                                            " per word")
        self.label_search_time = wx.StaticText(self.splitterwindow_rightpanel,
                                               -1,
                                               "Maximal search time per word: ",
                                               style=wx.ST_NO_AUTORESIZE)
        self.choice_search_time = wx.SpinCtrl(self.splitterwindow_rightpanel,
                                              -1, "10", min=0, max=3600)
        self.label_seconds = wx.StaticText(self.splitterwindow_rightpanel, -1,
                                           " seconds")
        self.choice_match_segment_length = wx.CheckBox(
            self.splitterwindow_rightpanel, -1,
        ...
        self.choice_overlapping_segments = wx.CheckBox(
            self.splitterwindow_rightpanel, -1, "Match subsyllabic segments: ")
        self.overlapping_segments_numerator = wx.TextCtrl(
            self.splitterwindow_rightpanel, -1, "2")
        self.fraction_label = wx.StaticText(self.splitterwindow_rightpanel, -1,
                                            " out of ")
        self.overlapping_segments_denominator = wx.TextCtrl(
            self.splitterwindow_rightpanel, -1, "3")
        self.choice_output_mode = wx.Choice(self.splitterwindow_rightpanel, -1,
                                            choices=["Plain", "Syllables",
                                                     "Segments"])
        self.choice_output_lexicality = wx.CheckBox(
            self.splitterwindow_rightpanel, -1, "Lexicality")
        self.choice_output_old20 = wx.CheckBox(self.splitterwindow_rightpanel,
                                               -1, "OLD20")
        self.choice_output_ned1 = wx.CheckBox(self.splitterwindow_rightpanel,
                                              -1,
                                              "Neighbors at edit distance 1")
        self.choice_output_overlap = wx.CheckBox(self.splitterwindow_rightpanel,
                                                 -1,
        ...
        self.Bind(wx.EVT_CHOICE, self.OnChoiceOutputType,
                  self.choice_output_type)
        self.Bind(wx.EVT_CHOICE, self.OnChoiceOutputMode,
                  self.choice_output_mode)
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        outputopts_sizer = wx.StaticBoxSizer(self.outputopts_sizer_staticbox,
                                             wx.VERTICAL)
        filter_sizer = wx.StaticBoxSizer(self.filter_sizer_staticbox,
                                         wx.VERTICAL)
        ...
        languagemodule_sizer.Add(self.label_generator, 0,
                                 wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        languagemodule_sizer.Add(self.choice_language, 1,
                                 wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        generalsettings_sizer.Add(languagemodule_sizer, 1, wx.EXPAND, 0)
        sizer_1.Add(self.label_output_type, 0,
                    wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_1.Add(self.choice_output_type, 0,
                    wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        generalsettings_sizer.Add(sizer_1, 1, wx.EXPAND, 0)
        ncandidates_sizer.Add(self.label_ncandidates, 0,
                              wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        ncandidates_subsizer.Add(self.choice_ncandidates, 0,
                                 wx.ALIGN_CENTER_VERTICAL, 0)
        ncandidates_subsizer.Add(self.label_per_word, 0,
                                 wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        ncandidates_sizer.Add(ncandidates_subsizer, 1, wx.EXPAND, 0)
        generalsettings_sizer.Add(ncandidates_sizer, 1, wx.EXPAND, 0)
        searchtime_sizer.Add(self.label_search_time, 0,
                             wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        searchtime_subsizer.Add(self.choice_search_time, 0,
                                wx.ALIGN_CENTER_VERTICAL, 0)
        searchtime_subsizer.Add(self.label_seconds, 0,
                                wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        searchtime_sizer.Add(searchtime_subsizer, 1, wx.EXPAND, 0)
        generalsettings_sizer.Add(searchtime_sizer, 1, wx.EXPAND, 0)
        settingspanel_sizer.Add(generalsettings_sizer, 0,
                                wx.LEFT | wx.RIGHT | wx.EXPAND, 20)
        filter_sizer.Add(self.choice_match_segment_length, 1,
                         wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        filter_sizer.Add(self.choice_match_plain_length, 1,
                         wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        filter_sizer.Add(self.choice_concentric_matching, 1,
                         wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        segmentmatch_sizer.Add(self.choice_overlapping_segments, 0,
                               wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        segmentmatch_sizer.Add(self.overlapping_segments_numerator, 1,
                               wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        segmentmatch_sizer.Add(self.fraction_label, 1, wx.EXPAND, 0)
        segmentmatch_sizer.Add(self.overlapping_segments_denominator, 1,
                               wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        filter_sizer.Add(segmentmatch_sizer, 1, wx.EXPAND, 0)
        settingspanel_sizer.Add(filter_sizer, 0, wx.LEFT | wx.RIGHT | wx.EXPAND,
                                20)
        outputopts_sizer.Add(self.choice_output_mode, 1,
                             wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        outputopts_sizer.Add(self.choice_output_lexicality, 1,
                             wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        outputopts_sizer.Add(self.choice_output_old20, 1,
                             wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        outputopts_sizer.Add(self.choice_output_ned1, 1,
                             wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        outputopts_sizer.Add(self.choice_output_overlap, 1,
                             wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        outputopts_sizer.Add(self.choice_output_max_deviation, 1,
                             wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        settingspanel_sizer.Add(outputopts_sizer, 0,
                                wx.LEFT | wx.RIGHT | wx.EXPAND, 20)
        self.splitterwindow_rightpanel.SetSizer(settingspanel_sizer)
        self.splitterwindow.SplitVertically(self.splitterwindow_leftpanel,
                                            self.splitterwindow_rightpanel, 480)
    ...
    def OnChoiceModule(self, event):  # wxGlade: MainWindow.<event_handler>
        ...
        if module_name.startswith("Choose"):
            ...
            t = threading.Thread(target=self.generator.Load,
                                 args=[plugin_module, 100, 1, False])
            t.start()
            ...
            while 1:
                t.join(0.1)
                if t.isAlive():
                    dialog.Update(self.generator.status['progress'],
    ...
    def OnMenuRun(self, event):  # wxGlade: MainWindow.<event_handler>
        if not self.VerifyModuleLoaded():
            return False
        ...
        self.CollectOptions()
        colnames = (
        'lexicality', 'old20', 'ned1', 'overlap_ratio', 'maxdeviation')
        columns = []
        ...
        for word, segments, expression in array:
            if segments == "":
                ...
                self.generator.Run(self.options, segments, expression,
                                   self.outputwindow)
                if self.stop == True:
                    break
    ...
    def CollectOptions(self):
        ...
        self.options[
            'match_segment_length'] = self.choice_match_segment_length.GetValue()
        self.options[
            'match_plain_length'] = self.choice_match_plain_length.GetValue()
        self.options['concentric'] = self.choice_concentric_matching.GetValue()
        self.options[
            'overlapping_segments'] = self.choice_overlapping_segments.GetValue()
        self.options[
            'overlap_numerator'] = self.overlapping_segments_numerator.GetValue()
        self.options[
            'overlap_denominator'] = self.overlapping_segments_denominator.GetValue()
        ...
        self.options[
            'maxdeviation'] = self.choice_output_max_deviation.GetValue()
    ...
    def OnMenuSegment(self, event):  # wxGlade: MainWindow.<event_handler>
        ...
        if wx.ID_OK == dialog.ShowModal():
            ...
            if result == "cancel":
                ...
                if len(warnings) > 0:
                    dialog = wx.lib.dialogs.ScrolledMessageDialog(self,
                                                                  u"\n".join(
                                                                      warnings),
                                                                  "Warnings")
                    dialog.ShowModal()
    ...
    def VerifyInput(self, quiet=True):
        ...
        for rownum, (word, segments, expression) in enumerate(array):
            if expression != u'':
                try:
                    ...
                    errors.append("error: invalid expression on row %d: %s" % (
                    rownum + 1, expression))
            if segments == '':
                warnings.append(
        ...
        if len(errors + warnings) > 0:
            dialog = wx.lib.dialogs.ScrolledMessageDialog(self, message_text,
                                                          'Verify Input')
            dialog.ShowModal()
            dialog.Destroy()
            if len(errors) > 0:
    ...
    def VerifyModuleLoaded(self):
        if self.generator.loaded == False:
            dialog = wx.MessageDialog(self, "No language module loaded",
                                      "Warning")
            dialog.ShowModal()
            dialog.Destroy()
            return False
